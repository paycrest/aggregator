...
const (
	// Label holds the string label denoting the paymentorderfulfillment type in the database.
	Label = "payment_order_fulfillment"
	...
	EdgeOrder = "order"
	// Table holds the table name of the paymentorderfulfillment in the database.
	Table = "payment_order_fulfillments"
	// OrderTable is the table that holds the order relation/edge.
	OrderTable = "payment_order_fulfillments"
	...
	OrderColumn = "payment_order_fulfillments"
)

// Columns holds all SQL columns for paymentorderfulfillment fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "payment_order_fulfillments"
...
const (
	...
	ValidationStatusRefunded ValidationStatus = "refunded"
)
...
func ValidationStatusValidator(vs ValidationStatus) error {
	switch vs {
	case ValidationStatusPending, ValidationStatusSuccess, ValidationStatusFailed, ValidationStatusRefunded:
		return nil
	default:
		return fmt.Errorf("paymentorderfulfillment: invalid enum value for validation_status field: %q", vs)
	}
}

// OrderOption defines the ordering options for the PaymentOrderFulfillment queries.
