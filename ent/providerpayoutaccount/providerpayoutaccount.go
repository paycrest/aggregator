...
const (
	// Label holds the string label denoting the providerpayoutaccount type in the database.
	Label = "provider_payout_account"
	...
	// Table holds the table name of the providerpayoutaccount in the database.
	Table = "provider_payout_accounts"
	// ProviderTable is the table that holds the provider relation/edge.
	ProviderTable = "provider_payout_accounts"
	...
	ProviderColumn = "provider_profile_provider_payout_accounts"
)

// Columns holds all SQL columns for providerpayoutaccount fields.
var Columns = []string{
	FieldID,
	FieldInstitution,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "provider_payout_accounts"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"provider_profile_provider_payout_accounts",
}
...
// OrderOption defines the ordering options for the ProviderPayoutAccount queries.
