...
const (
	// Label holds the string label denoting the kybformsubmission type in the database.
	Label = "kyb_form_submission"
	...
	EdgeUser = "user"
	// Table holds the table name of the kybformsubmission in the database.
	Table = "kyb_form_submissions"
	...
	BeneficialOwnersColumn = "kyb_form_submission_beneficial_owners"
	// UserTable is the table that holds the user relation/edge.
	UserTable = "kyb_form_submissions"
	// UserInverseTable is the table name for the User entity.
	// It exists in this package in order to avoid circular dependency with the "user" package.
	UserInverseTable = "users"
	// UserColumn is the table column denoting the user relation/edge.
	UserColumn = "kyb_form_submission_user"
)

// Columns holds all SQL columns for kybformsubmission fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "kyb_form_submissions"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"kyb_form_submission_user",
}
...
// OrderOption defines the ordering options for the KYBFormSubmission queries.
