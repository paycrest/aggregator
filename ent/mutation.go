...
const (
	...
	TypeSenderFiatAccount           = "SenderFiatAccount"
...
func (m *FiatCurrencyMutation) AddProviderBalanceIDs(ids ...uuid.UUID) {
	if m.provider_balances == nil {
		m.provider_balances = make(map[uuid.UUID]struct{})
	}
	for i := range ids {
		m.provider_balances[ids[i]] = struct{}{}
	}
}

// ClearProviderBalances clears the "provider_balances" edge to the ProviderBalances entity.
func (m *FiatCurrencyMutation) ClearProviderBalances() {
	m.clearedprovider_balances = true
}

// ProviderBalancesCleared reports if the "provider_balances" edge to the ProviderBalances entity was cleared.
func (m *FiatCurrencyMutation) ProviderBalancesCleared() bool {
	return m.clearedprovider_balances
}

// RemoveProviderBalanceIDs removes the "provider_balances" edge to the ProviderBalances entity by IDs.
func (m *FiatCurrencyMutation) RemoveProviderBalanceIDs(ids ...uuid.UUID) {
	if m.removedprovider_balances == nil {
		m.removedprovider_balances = make(map[uuid.UUID]struct{})
	}
	for i := range ids {
		delete(m.provider_balances, ids[i])
		m.removedprovider_balances[ids[i]] = struct{}{}
	}
}

// RemovedProviderBalances returns the removed IDs of the "provider_balances" edge to the ProviderBalances entity.
func (m *FiatCurrencyMutation) RemovedProviderBalancesIDs() (ids []uuid.UUID) {
...
// ProviderBalancesIDs returns the "provider_balances" edge IDs in the mutation.
func (m *FiatCurrencyMutation) ProviderBalancesIDs() (ids []uuid.UUID) {
...
// ResetProviderBalances resets all changes to the "provider_balances" edge.
func (m *FiatCurrencyMutation) ResetProviderBalances() {
	m.provider_balances = nil
	m.clearedprovider_balances = false
...
// providerbalancesOption allows management of the mutation configuration using functional options.
type providerbalancesOption func(*ProviderBalancesMutation)

// newProviderBalancesMutation creates new mutation for the ProviderBalances entity.
func newProviderBalancesMutation(c config, op Op, opts ...providerbalancesOption) *ProviderBalancesMutation {
	m := &ProviderBalancesMutation{
		config:        c,
		op:            op,
		typ:           TypeProviderBalances,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withProviderBalancesID sets the ID field of the mutation.
func withProviderBalancesID(id uuid.UUID) providerbalancesOption {
	return func(m *ProviderBalancesMutation) {
		var (
			err   error
			once  sync.Once
			value *ProviderBalances
		)
		m.oldValue = func(ctx context.Context) (*ProviderBalances, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().ProviderBalances.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withProviderBalances sets the old ProviderBalances of the mutation.
func withProviderBalances(node *ProviderBalances) providerbalancesOption {
	return func(m *ProviderBalancesMutation) {
		m.oldValue = func(context.Context) (*ProviderBalances, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m ProviderBalancesMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// SetID sets the value of the id field. Note that this
// operation is only accepted on creation of ProviderBalances entities.
func (m *ProviderBalancesMutation) SetID(id uuid.UUID) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *ProviderBalancesMutation) ID() (id uuid.UUID, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *ProviderBalancesMutation) IDs(ctx context.Context) ([]uuid.UUID, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().ProviderBalances.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
func (m *ProviderBalancesMutation) SetAvailableBalance(d decimal.Decimal) {
...
func (m *ProviderBalancesMutation) AvailableBalance() (r decimal.Decimal, exists bool) {
...
// OldAvailableBalance returns the old "available_balance" field's value of the ProviderBalances entity.
// If the ProviderBalances object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ProviderBalancesMutation) OldAvailableBalance(ctx context.Context) (v decimal.Decimal, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ProviderBalancesMutation) AddAvailableBalance(d decimal.Decimal) {
...
func (m *ProviderBalancesMutation) AddedAvailableBalance() (r decimal.Decimal, exists bool) {
...
func (m *ProviderBalancesMutation) ResetAvailableBalance() {
	m.available_balance = nil
	m.addavailable_balance = nil
}

// SetTotalBalance sets the "total_balance" field.
func (m *ProviderBalancesMutation) SetTotalBalance(d decimal.Decimal) {
	m.total_balance = &d
	m.addtotal_balance = nil
}

// TotalBalance returns the value of the "total_balance" field in the mutation.
func (m *ProviderBalancesMutation) TotalBalance() (r decimal.Decimal, exists bool) {
	v := m.total_balance
	if v == nil {
		return
	}
...
// OldTotalBalance returns the old "total_balance" field's value of the ProviderBalances entity.
// If the ProviderBalances object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ProviderBalancesMutation) OldTotalBalance(ctx context.Context) (v decimal.Decimal, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ProviderBalancesMutation) AddTotalBalance(d decimal.Decimal) {
...
func (m *ProviderBalancesMutation) AddedTotalBalance() (r decimal.Decimal, exists bool) {
...
func (m *ProviderBalancesMutation) ResetTotalBalance() {
	m.total_balance = nil
	m.addtotal_balance = nil
}

// SetReservedBalance sets the "reserved_balance" field.
func (m *ProviderBalancesMutation) SetReservedBalance(d decimal.Decimal) {
...
func (m *ProviderBalancesMutation) ReservedBalance() (r decimal.Decimal, exists bool) {
...
// OldReservedBalance returns the old "reserved_balance" field's value of the ProviderBalances entity.
// If the ProviderBalances object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ProviderBalancesMutation) OldReservedBalance(ctx context.Context) (v decimal.Decimal, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ProviderBalancesMutation) AddReservedBalance(d decimal.Decimal) {
...
func (m *ProviderBalancesMutation) AddedReservedBalance() (r decimal.Decimal, exists bool) {
...
func (m *ProviderBalancesMutation) ResetReservedBalance() {
	m.reserved_balance = nil
	m.addreserved_balance = nil
}

// SetIsAvailable sets the "is_available" field.
func (m *ProviderBalancesMutation) SetIsAvailable(b bool) {
	m.is_available = &b
}

// IsAvailable returns the value of the "is_available" field in the mutation.
func (m *ProviderBalancesMutation) IsAvailable() (r bool, exists bool) {
	v := m.is_available
	if v == nil {
		return
	}
...
// OldIsAvailable returns the old "is_available" field's value of the ProviderBalances entity.
// If the ProviderBalances object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ProviderBalancesMutation) OldIsAvailable(ctx context.Context) (v bool, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ProviderBalancesMutation) ResetIsAvailable() {
	m.is_available = nil
}

// SetUpdatedAt sets the "updated_at" field.
func (m *ProviderBalancesMutation) SetUpdatedAt(t time.Time) {
	m.updated_at = &t
}

// UpdatedAt returns the value of the "updated_at" field in the mutation.
func (m *ProviderBalancesMutation) UpdatedAt() (r time.Time, exists bool) {
	v := m.updated_at
	if v == nil {
		return
	}
...
// OldUpdatedAt returns the old "updated_at" field's value of the ProviderBalances entity.
// If the ProviderBalances object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ProviderBalancesMutation) OldUpdatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUpdatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetUpdatedAt resets all changes to the "updated_at" field.
func (m *ProviderBalancesMutation) ResetUpdatedAt() {
	m.updated_at = nil
}
...
// ClearProvider clears the "provider" edge to the ProviderProfile entity.
func (m *ProviderBalancesMutation) ClearProvider() {
	m.clearedprovider = true
}

// ProviderCleared reports if the "provider" edge to the ProviderProfile entity was cleared.
func (m *ProviderBalancesMutation) ProviderCleared() bool {
	return m.clearedprovider
}
...
// SetFiatCurrencyID sets the "fiat_currency" edge to the FiatCurrency entity by id.
func (m *ProviderBalancesMutation) SetFiatCurrencyID(id uuid.UUID) {
	m.fiat_currency = &id
}

// ClearFiatCurrency clears the "fiat_currency" edge to the FiatCurrency entity.
func (m *ProviderBalancesMutation) ClearFiatCurrency() {
	m.clearedfiat_currency = true
}

// FiatCurrencyCleared reports if the "fiat_currency" edge to the FiatCurrency entity was cleared.
func (m *ProviderBalancesMutation) FiatCurrencyCleared() bool {
	return m.clearedfiat_currency
}

// FiatCurrencyID returns the "fiat_currency" edge ID in the mutation.
func (m *ProviderBalancesMutation) FiatCurrencyID() (id uuid.UUID, exists bool) {
	if m.fiat_currency != nil {
		return *m.fiat_currency, true
	}
	return
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// FiatCurrencyID instead. It exists only for internal usage by the builders.
func (m *ProviderBalancesMutation) FiatCurrencyIDs() (ids []uuid.UUID) {
	if id := m.fiat_currency; id != nil {
		ids = append(ids, *id)
	}
	return
...
// ResetFiatCurrency resets all changes to the "fiat_currency" edge.
func (m *ProviderBalancesMutation) ResetFiatCurrency() {
	m.fiat_currency = nil
	m.clearedfiat_currency = false
}

// SetTokenID sets the "token" edge to the Token entity by id.
func (m *ProviderBalancesMutation) SetTokenID(id int) {
	m.token = &id
}

// ClearToken clears the "token" edge to the Token entity.
func (m *ProviderBalancesMutation) ClearToken() {
	m.clearedtoken = true
}

// TokenCleared reports if the "token" edge to the Token entity was cleared.
func (m *ProviderBalancesMutation) TokenCleared() bool {
	return m.clearedtoken
}

// TokenID returns the "token" edge ID in the mutation.
func (m *ProviderBalancesMutation) TokenID() (id int, exists bool) {
	if m.token != nil {
		return *m.token, true
	}
	return
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// TokenID instead. It exists only for internal usage by the builders.
func (m *ProviderBalancesMutation) TokenIDs() (ids []int) {
	if id := m.token; id != nil {
		ids = append(ids, *id)
	}
	return
...
// ResetToken resets all changes to the "token" edge.
func (m *ProviderBalancesMutation) ResetToken() {
	m.token = nil
	m.clearedtoken = false
}

// Where appends a list predicates to the ProviderBalancesMutation builder.
func (m *ProviderBalancesMutation) Where(ps ...predicate.ProviderBalances) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the ProviderBalancesMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *ProviderBalancesMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.ProviderBalances, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *ProviderBalancesMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *ProviderBalancesMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (ProviderBalances).
func (m *ProviderBalancesMutation) Type() string {
	return m.typ
}
...
func (m *ProviderBalancesMutation) Fields() []string {
	...
	if m.total_balance != nil {
		fields = append(fields, providerbalances.FieldTotalBalance)
	}
	if m.reserved_balance != nil {
		fields = append(fields, providerbalances.FieldReservedBalance)
	}
	if m.is_available != nil {
		fields = append(fields, providerbalances.FieldIsAvailable)
	}
	if m.updated_at != nil {
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *ProviderBalancesMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *ProviderBalancesMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case providerbalances.FieldAvailableBalance:
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *ProviderBalancesMutation) SetField(name string, value ent.Value) error {
	switch name {
	case providerbalances.FieldAvailableBalance:
		v, ok := value.(decimal.Decimal)
		if !ok {
...
// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *ProviderBalancesMutation) AddedFields() []string {
	var fields []string
	if m.addavailable_balance != nil {
		fields = append(fields, providerbalances.FieldAvailableBalance)
	}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *ProviderBalancesMutation) AddedField(name string) (ent.Value, bool) {
	switch name {
	case providerbalances.FieldAvailableBalance:
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *ProviderBalancesMutation) AddField(name string, value ent.Value) error {
	switch name {
	case providerbalances.FieldAvailableBalance:
		v, ok := value.(decimal.Decimal)
		if !ok {
...
// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *ProviderBalancesMutation) ClearedFields() []string {
	return nil
}

// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *ProviderBalancesMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *ProviderBalancesMutation) ClearField(name string) error {
	return fmt.Errorf("unknown ProviderBalances nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *ProviderBalancesMutation) ResetField(name string) error {
	switch name {
	case providerbalances.FieldAvailableBalance:
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *ProviderBalancesMutation) AddedEdges() []string {
	edges := make([]string, 0, 3)
	if m.provider != nil {
		edges = append(edges, providerbalances.EdgeProvider)
	}
	if m.fiat_currency != nil {
		edges = append(edges, providerbalances.EdgeFiatCurrency)
	}
	if m.token != nil {
		edges = append(edges, providerbalances.EdgeToken)
	}
	return edges
}
...
func (m *ProviderBalancesMutation) AddedIDs(name string) []ent.Value {
	...
	case providerbalances.EdgeToken:
		if id := m.token; id != nil {
			return []ent.Value{*id}
		}
	}
...
// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *ProviderBalancesMutation) ClearedEdges() []string {
	edges := make([]string, 0, 3)
	if m.clearedprovider {
		edges = append(edges, providerbalances.EdgeProvider)
	}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *ProviderBalancesMutation) EdgeCleared(name string) bool {
	switch name {
	case providerbalances.EdgeProvider:
		return m.clearedprovider
	case providerbalances.EdgeFiatCurrency:
...
func (m *ProviderBalancesMutation) ClearEdge(name string) error {
	...
	return fmt.Errorf("unknown ProviderBalances unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *ProviderBalancesMutation) ResetEdge(name string) error {
	switch name {
	case providerbalances.EdgeProvider:
		m.ResetProvider()
		return nil
	...
	return fmt.Errorf("unknown ProviderBalances edge %s", name)
}
...
// AddProviderBalanceIDs adds the "provider_balances" edge to the ProviderBalances entity by ids.
func (m *ProviderProfileMutation) AddProviderBalanceIDs(ids ...uuid.UUID) {
	if m.provider_balances == nil {
		m.provider_balances = make(map[uuid.UUID]struct{})
	}
	for i := range ids {
...
// ClearProviderBalances clears the "provider_balances" edge to the ProviderBalances entity.
func (m *ProviderProfileMutation) ClearProviderBalances() {
	m.clearedprovider_balances = true
}

// ProviderBalancesCleared reports if the "provider_balances" edge to the ProviderBalances entity was cleared.
func (m *ProviderProfileMutation) ProviderBalancesCleared() bool {
	return m.clearedprovider_balances
}

// RemoveProviderBalanceIDs removes the "provider_balances" edge to the ProviderBalances entity by IDs.
func (m *ProviderProfileMutation) RemoveProviderBalanceIDs(ids ...uuid.UUID) {
	if m.removedprovider_balances == nil {
		m.removedprovider_balances = make(map[uuid.UUID]struct{})
	}
	for i := range ids {
...
// RemovedProviderBalances returns the removed IDs of the "provider_balances" edge to the ProviderBalances entity.
func (m *ProviderProfileMutation) RemovedProviderBalancesIDs() (ids []uuid.UUID) {
	for id := range m.removedprovider_balances {
		ids = append(ids, id)
	}
	return
...
// ProviderBalancesIDs returns the "provider_balances" edge IDs in the mutation.
func (m *ProviderProfileMutation) ProviderBalancesIDs() (ids []uuid.UUID) {
	for id := range m.provider_balances {
		ids = append(ids, id)
	}
	return
...
// ResetProviderBalances resets all changes to the "provider_balances" edge.
func (m *ProviderProfileMutation) ResetProviderBalances() {
	m.provider_balances = nil
	m.clearedprovider_balances = false
	m.removedprovider_balances = nil
}
...
// SenderFiatAccountMutation represents an operation that mutates the SenderFiatAccount nodes in the graph.
type SenderFiatAccountMutation struct {
	config
	op                 Op
	typ                string
	id                 *uuid.UUID
	...
	oldValue           func(context.Context) (*SenderFiatAccount, error)
	predicates         []predicate.SenderFiatAccount
}

var _ ent.Mutation = (*SenderFiatAccountMutation)(nil)

// senderfiataccountOption allows management of the mutation configuration using functional options.
type senderfiataccountOption func(*SenderFiatAccountMutation)

// newSenderFiatAccountMutation creates new mutation for the SenderFiatAccount entity.
func newSenderFiatAccountMutation(c config, op Op, opts ...senderfiataccountOption) *SenderFiatAccountMutation {
	m := &SenderFiatAccountMutation{
		config:        c,
		op:            op,
		typ:           TypeSenderFiatAccount,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withSenderFiatAccountID sets the ID field of the mutation.
func withSenderFiatAccountID(id uuid.UUID) senderfiataccountOption {
	return func(m *SenderFiatAccountMutation) {
		var (
			err   error
			once  sync.Once
			value *SenderFiatAccount
		)
		m.oldValue = func(ctx context.Context) (*SenderFiatAccount, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().SenderFiatAccount.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withSenderFiatAccount sets the old SenderFiatAccount of the mutation.
func withSenderFiatAccount(node *SenderFiatAccount) senderfiataccountOption {
	return func(m *SenderFiatAccountMutation) {
		m.oldValue = func(context.Context) (*SenderFiatAccount, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m SenderFiatAccountMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m SenderFiatAccountMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// SetID sets the value of the id field. Note that this
// operation is only accepted on creation of SenderFiatAccount entities.
func (m *SenderFiatAccountMutation) SetID(id uuid.UUID) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *SenderFiatAccountMutation) ID() (id uuid.UUID, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *SenderFiatAccountMutation) IDs(ctx context.Context) ([]uuid.UUID, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().SenderFiatAccount.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetCreatedAt sets the "created_at" field.
func (m *SenderFiatAccountMutation) SetCreatedAt(t time.Time) {
	m.created_at = &t
}

// CreatedAt returns the value of the "created_at" field in the mutation.
func (m *SenderFiatAccountMutation) CreatedAt() (r time.Time, exists bool) {
	v := m.created_at
	if v == nil {
		return
	}
...
// OldCreatedAt returns the old "created_at" field's value of the SenderFiatAccount entity.
// If the SenderFiatAccount object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SenderFiatAccountMutation) OldCreatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCreatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetCreatedAt resets all changes to the "created_at" field.
func (m *SenderFiatAccountMutation) ResetCreatedAt() {
	m.created_at = nil
}

// SetUpdatedAt sets the "updated_at" field.
func (m *SenderFiatAccountMutation) SetUpdatedAt(t time.Time) {
	m.updated_at = &t
}

// UpdatedAt returns the value of the "updated_at" field in the mutation.
func (m *SenderFiatAccountMutation) UpdatedAt() (r time.Time, exists bool) {
	v := m.updated_at
	if v == nil {
		return
	}
...
// OldUpdatedAt returns the old "updated_at" field's value of the SenderFiatAccount entity.
// If the SenderFiatAccount object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SenderFiatAccountMutation) OldUpdatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUpdatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetUpdatedAt resets all changes to the "updated_at" field.
func (m *SenderFiatAccountMutation) ResetUpdatedAt() {
	m.updated_at = nil
}

// SetInstitution sets the "institution" field.
func (m *SenderFiatAccountMutation) SetInstitution(s string) {
	m.institution = &s
}

// Institution returns the value of the "institution" field in the mutation.
func (m *SenderFiatAccountMutation) Institution() (r string, exists bool) {
	v := m.institution
	if v == nil {
		return
	}
...
// OldInstitution returns the old "institution" field's value of the SenderFiatAccount entity.
// If the SenderFiatAccount object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SenderFiatAccountMutation) OldInstitution(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldInstitution is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetInstitution resets all changes to the "institution" field.
func (m *SenderFiatAccountMutation) ResetInstitution() {
	m.institution = nil
}

// SetAccountIdentifier sets the "account_identifier" field.
func (m *SenderFiatAccountMutation) SetAccountIdentifier(s string) {
	m.account_identifier = &s
}

// AccountIdentifier returns the value of the "account_identifier" field in the mutation.
func (m *SenderFiatAccountMutation) AccountIdentifier() (r string, exists bool) {
	v := m.account_identifier
	if v == nil {
		return
	}
...
// OldAccountIdentifier returns the old "account_identifier" field's value of the SenderFiatAccount entity.
// If the SenderFiatAccount object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SenderFiatAccountMutation) OldAccountIdentifier(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldAccountIdentifier is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetAccountIdentifier resets all changes to the "account_identifier" field.
func (m *SenderFiatAccountMutation) ResetAccountIdentifier() {
	m.account_identifier = nil
}

// SetAccountName sets the "account_name" field.
func (m *SenderFiatAccountMutation) SetAccountName(s string) {
	m.account_name = &s
}

// AccountName returns the value of the "account_name" field in the mutation.
func (m *SenderFiatAccountMutation) AccountName() (r string, exists bool) {
	v := m.account_name
	if v == nil {
		return
	}
...
// OldAccountName returns the old "account_name" field's value of the SenderFiatAccount entity.
// If the SenderFiatAccount object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SenderFiatAccountMutation) OldAccountName(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldAccountName is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
func (m *SenderFiatAccountMutation) SenderIDs() (ids []uuid.UUID) {
...
func (m *SenderFiatAccountMutation) ResetSender() {
	m.sender = nil
	m.clearedsender = false
}

// Where appends a list predicates to the SenderFiatAccountMutation builder.
func (m *SenderFiatAccountMutation) Where(ps ...predicate.SenderFiatAccount) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the SenderFiatAccountMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *SenderFiatAccountMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.SenderFiatAccount, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *SenderFiatAccountMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *SenderFiatAccountMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (SenderFiatAccount).
func (m *SenderFiatAccountMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *SenderFiatAccountMutation) Fields() []string {
	fields := make([]string, 0, 5)
	if m.created_at != nil {
		fields = append(fields, senderfiataccount.FieldCreatedAt)
	}
	if m.updated_at != nil {
		fields = append(fields, senderfiataccount.FieldUpdatedAt)
	}
	if m.institution != nil {
		fields = append(fields, senderfiataccount.FieldInstitution)
	}
	if m.account_identifier != nil {
		fields = append(fields, senderfiataccount.FieldAccountIdentifier)
	}
	if m.account_name != nil {
		fields = append(fields, senderfiataccount.FieldAccountName)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *SenderFiatAccountMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *SenderFiatAccountMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case senderfiataccount.FieldCreatedAt:
		return m.OldCreatedAt(ctx)
	case senderfiataccount.FieldUpdatedAt:
	...
	return nil, fmt.Errorf("unknown SenderFiatAccount field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *SenderFiatAccountMutation) SetField(name string, value ent.Value) error {
	switch name {
	case senderfiataccount.FieldCreatedAt:
		v, ok := value.(time.Time)
		if !ok {
	...
	return fmt.Errorf("unknown SenderFiatAccount field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *SenderFiatAccountMutation) AddedFields() []string {
	return nil
}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *SenderFiatAccountMutation) AddedField(name string) (ent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *SenderFiatAccountMutation) AddField(name string, value ent.Value) error {
	switch name {
	}
	return fmt.Errorf("unknown SenderFiatAccount numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *SenderFiatAccountMutation) ClearedFields() []string {
	return nil
}

// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *SenderFiatAccountMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *SenderFiatAccountMutation) ClearField(name string) error {
	return fmt.Errorf("unknown SenderFiatAccount nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *SenderFiatAccountMutation) ResetField(name string) error {
	switch name {
	case senderfiataccount.FieldCreatedAt:
		m.ResetCreatedAt()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *SenderFiatAccountMutation) AddedEdges() []string {
	edges := make([]string, 0, 1)
	if m.sender != nil {
		edges = append(edges, senderfiataccount.EdgeSender)
	}
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *SenderFiatAccountMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case senderfiataccount.EdgeSender:
		if id := m.sender; id != nil {
			return []ent.Value{*id}
		}
	}
...
// RemovedEdges returns all edge names that were removed in this mutation.
func (m *SenderFiatAccountMutation) RemovedEdges() []string {
	edges := make([]string, 0, 1)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *SenderFiatAccountMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *SenderFiatAccountMutation) ClearedEdges() []string {
	edges := make([]string, 0, 1)
	if m.clearedsender {
		edges = append(edges, senderfiataccount.EdgeSender)
	}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *SenderFiatAccountMutation) EdgeCleared(name string) bool {
	switch name {
	case senderfiataccount.EdgeSender:
		return m.clearedsender
	}
...
// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *SenderFiatAccountMutation) ClearEdge(name string) error {
	switch name {
	case senderfiataccount.EdgeSender:
		m.ClearSender()
		return nil
	}
	return fmt.Errorf("unknown SenderFiatAccount unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *SenderFiatAccountMutation) ResetEdge(name string) error {
	switch name {
	case senderfiataccount.EdgeSender:
		m.ResetSender()
		return nil
	}
	return fmt.Errorf("unknown SenderFiatAccount edge %s", name)
}
...
type SenderProfileMutation struct {
	...
	removedorder_tokens    map[int]struct{}
	clearedorder_tokens    bool
	refund_accounts        map[uuid.UUID]struct{}
	removedrefund_accounts map[uuid.UUID]struct{}
	clearedrefund_accounts bool
	done                   bool
...
func (m *SenderProfileMutation) AddRefundAccountIDs(ids ...uuid.UUID) {
	if m.refund_accounts == nil {
		m.refund_accounts = make(map[uuid.UUID]struct{})
	}
	for i := range ids {
		m.refund_accounts[ids[i]] = struct{}{}
	}
}

// ClearRefundAccounts clears the "refund_accounts" edge to the SenderFiatAccount entity.
func (m *SenderProfileMutation) ClearRefundAccounts() {
	m.clearedrefund_accounts = true
}

// RefundAccountsCleared reports if the "refund_accounts" edge to the SenderFiatAccount entity was cleared.
func (m *SenderProfileMutation) RefundAccountsCleared() bool {
	return m.clearedrefund_accounts
}

// RemoveRefundAccountIDs removes the "refund_accounts" edge to the SenderFiatAccount entity by IDs.
func (m *SenderProfileMutation) RemoveRefundAccountIDs(ids ...uuid.UUID) {
	if m.removedrefund_accounts == nil {
		m.removedrefund_accounts = make(map[uuid.UUID]struct{})
	}
	for i := range ids {
		delete(m.refund_accounts, ids[i])
		m.removedrefund_accounts[ids[i]] = struct{}{}
	}
}

// RemovedRefundAccounts returns the removed IDs of the "refund_accounts" edge to the SenderFiatAccount entity.
func (m *SenderProfileMutation) RemovedRefundAccountsIDs() (ids []uuid.UUID) {
	for id := range m.removedrefund_accounts {
		ids = append(ids, id)
	}
	return
}

// RefundAccountsIDs returns the "refund_accounts" edge IDs in the mutation.
func (m *SenderProfileMutation) RefundAccountsIDs() (ids []uuid.UUID) {
	for id := range m.refund_accounts {
		ids = append(ids, id)
	}
	return
}

// ResetRefundAccounts resets all changes to the "refund_accounts" edge.
func (m *SenderProfileMutation) ResetRefundAccounts() {
	m.refund_accounts = nil
	m.clearedrefund_accounts = false
	m.removedrefund_accounts = nil
}
...
func (m *SenderProfileMutation) AddedEdges() []string {
	...
	if m.refund_accounts != nil {
		edges = append(edges, senderprofile.EdgeRefundAccounts)
	}
	return edges
}
...
func (m *SenderProfileMutation) AddedIDs(name string) []ent.Value {
	...
	case senderprofile.EdgeOrderTokens:
		...
		return ids
	case senderprofile.EdgeRefundAccounts:
		ids := make([]ent.Value, 0, len(m.refund_accounts))
		for id := range m.refund_accounts {
			ids = append(ids, id)
		}
		return ids
...
func (m *SenderProfileMutation) RemovedIDs(name string) []ent.Value {
	...
	case senderprofile.EdgeOrderTokens:
		...
		return ids
	case senderprofile.EdgeRefundAccounts:
		ids := make([]ent.Value, 0, len(m.removedrefund_accounts))
		for id := range m.removedrefund_accounts {
			ids = append(ids, id)
		}
		return ids
...
// AddProviderBalanceIDs adds the "provider_balances" edge to the ProviderBalances entity by ids.
func (m *TokenMutation) AddProviderBalanceIDs(ids ...uuid.UUID) {
	if m.provider_balances == nil {
		m.provider_balances = make(map[uuid.UUID]struct{})
	}
	for i := range ids {
...
// ClearProviderBalances clears the "provider_balances" edge to the ProviderBalances entity.
func (m *TokenMutation) ClearProviderBalances() {
	m.clearedprovider_balances = true
}

// ProviderBalancesCleared reports if the "provider_balances" edge to the ProviderBalances entity was cleared.
func (m *TokenMutation) ProviderBalancesCleared() bool {
	return m.clearedprovider_balances
}

// RemoveProviderBalanceIDs removes the "provider_balances" edge to the ProviderBalances entity by IDs.
func (m *TokenMutation) RemoveProviderBalanceIDs(ids ...uuid.UUID) {
	if m.removedprovider_balances == nil {
		m.removedprovider_balances = make(map[uuid.UUID]struct{})
	}
	for i := range ids {
...
// RemovedProviderBalances returns the removed IDs of the "provider_balances" edge to the ProviderBalances entity.
func (m *TokenMutation) RemovedProviderBalancesIDs() (ids []uuid.UUID) {
	for id := range m.removedprovider_balances {
		ids = append(ids, id)
	}
	return
...
// ProviderBalancesIDs returns the "provider_balances" edge IDs in the mutation.
func (m *TokenMutation) ProviderBalancesIDs() (ids []uuid.UUID) {
	for id := range m.provider_balances {
		ids = append(ids, id)
	}
	return
...
// ResetProviderBalances resets all changes to the "provider_balances" edge.
func (m *TokenMutation) ResetProviderBalances() {
	m.provider_balances = nil
	m.clearedprovider_balances = false
	m.removedprovider_balances = nil
}
...
func (m *TokenMutation) AddedEdges() []string {
	...
	if m.provider_balances != nil {
		edges = append(edges, token.EdgeProviderBalances)
	}
	return edges
}
...
func (m *TokenMutation) AddedIDs(name string) []ent.Value {
	...
	case token.EdgeProviderOrderTokens:
		...
		return ids
	case token.EdgeProviderBalances:
		ids := make([]ent.Value, 0, len(m.provider_balances))
		for id := range m.provider_balances {
			ids = append(ids, id)
		}
