...
// HasProviderAssignments applies the HasEdge predicate on the "provider_assignments" edge.
func HasProviderAssignments() predicate.PaymentOrder {
	return predicate.PaymentOrder(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasProviderAssignmentsWith applies the HasEdge predicate on the "provider_assignments" edge with a given conditions (other predicates).
func HasProviderAssignmentsWith(preds ...predicate.ProviderOrderAssignment) predicate.PaymentOrder {
	return predicate.PaymentOrder(func(s *sql.Selector) {
		step := newProviderAssignmentsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
