...
const (
	// Label holds the string label denoting the providerfiataccount type in the database.
	...
	Table = "provider_fiat_accounts"
	// ProviderTable is the table that holds the provider relation/edge.
	ProviderTable = "provider_fiat_accounts"
...
// OrderOption defines the ordering options for the ProviderFiatAccount queries.
