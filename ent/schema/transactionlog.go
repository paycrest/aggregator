...
func (TransactionLog) Fields() []ent.Field {
	return []ent.Field{
		...
		field.Enum("status").
			Values("order_initiated", "crypto_deposited", "order_created", "order_fulfilling", "order_fulfilled", "order_validated", "order_settled", "order_refunded", "gas_prefunded", "gateway_approved").
