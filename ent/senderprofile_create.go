...
func (_c *SenderProfileCreate) AddLinkedAddresIDs(ids ...int) *SenderProfileCreate {
	_c.mutation.AddLinkedAddresIDs(ids...)
	return _c
}

// AddLinkedAddress adds the "linked_address" edges to the LinkedAddress entity.
func (_c *SenderProfileCreate) AddLinkedAddress(v ...*LinkedAddress) *SenderProfileCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddLinkedAddresIDs(ids...)
}
