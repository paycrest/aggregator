		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  true,
				Columns: []*schema.Column{LockPaymentOrdersColumns[4], LockPaymentOrdersColumns[6], LockPaymentOrdersColumns[8], LockPaymentOrdersColumns[10], LockPaymentOrdersColumns[11], LockPaymentOrdersColumns[12], LockPaymentOrdersColumns[13], LockPaymentOrdersColumns[14], LockPaymentOrdersColumns[19]},
			},
		},
	}
