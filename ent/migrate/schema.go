...
var (
	...
	PaymentOrdersColumns = []*schema.Column{
		...
		{Name: "provider_fee", Type: field.TypeFloat64},
		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  true,
				Columns: []*schema.Column{PaymentOrdersColumns[18], PaymentOrdersColumns[4], PaymentOrdersColumns[15], PaymentOrdersColumns[16], PaymentOrdersColumns[26], PaymentOrdersColumns[27], PaymentOrdersColumns[28], PaymentOrdersColumns[34], PaymentOrdersColumns[36], PaymentOrdersColumns[20], PaymentOrdersColumns[43]},
			},
		},
	}
	...
	SenderOrderTokensColumns = []*schema.Column{
		...
		{Name: "fee_address", Type: field.TypeString, Size: 70},
		{Name: "refund_address", Type: field.TypeString, Size: 70},
	...
	TokensColumns = []*schema.Column{
		...
		{Name: "contract_address", Type: field.TypeString, Size: 70},
