...
var (
	...
	BeneficialOwnersColumns = []*schema.Column{
		...
		{Name: "ownership_percentage", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "DECIMAL(20,8)"}},
	...
	FiatCurrenciesColumns = []*schema.Column{
		...
		{Name: "market_rate", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "DECIMAL(20,8)"}},
	...
	LockPaymentOrdersColumns = []*schema.Column{
		...
		{Name: "protocol_fee", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "DECIMAL(20,8)"}},
		{Name: "rate", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "DECIMAL(20,8)"}},
		{Name: "order_percent", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "DECIMAL(20,8)"}},
	...
	PaymentOrdersColumns = []*schema.Column{
		...
		{Name: "updated_at", Type: field.TypeTime},
		{Name: "amount", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "DECIMAL(20,8)"}},
		{Name: "amount_paid", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "DECIMAL(20,8)"}},
		{Name: "amount_returned", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "DECIMAL(20,8)"}},
		{Name: "percent_settled", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "DECIMAL(20,8)"}},
		{Name: "sender_fee", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "DECIMAL(20,8)"}},
		{Name: "network_fee", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "DECIMAL(20,8)"}},
		{Name: "rate", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "DECIMAL(20,8)"}},
		{Name: "tx_hash", Type: field.TypeString, Nullable: true, Size: 70},
		...
		{Name: "fee_percent", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "DECIMAL(20,8)"}},
	...
	PaymentWebhooksColumns = []*schema.Column{
		...
		{Name: "network_payment_webhook", Type: field.TypeInt, Unique: true, Nullable: true},
	...
	PaymentWebhooksTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "payment_webhooks_networks_payment_webhook",
	...
	ProviderCurrenciesColumns = []*schema.Column{
		{Name: "id", Type: field.TypeUUID},
		{Name: "available_balance", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "DECIMAL(20,8)"}},
		{Name: "total_balance", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "DECIMAL(20,8)"}},
		{Name: "reserved_balance", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "DECIMAL(20,8)"}},
	...
	ProviderOrderTokensColumns = []*schema.Column{
		...
		{Name: "created_at", Type: field.TypeTime},
		{Name: "updated_at", Type: field.TypeTime},
		{Name: "fixed_conversion_rate", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "DECIMAL(20,8)"}},
		{Name: "floating_conversion_rate", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "DECIMAL(20,8)"}},
		{Name: "conversion_rate_type", Type: field.TypeEnum, Enums: []string{"fixed", "floating"}},
		{Name: "max_order_amount", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "DECIMAL(20,8)"}},
		{Name: "min_order_amount", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "DECIMAL(20,8)"}},
		{Name: "rate_slippage", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "DECIMAL(20,8)"}},
	...
	ProviderRatingsColumns = []*schema.Column{
		...
		{Name: "created_at", Type: field.TypeTime},
		{Name: "updated_at", Type: field.TypeTime},
		{Name: "trust_score", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "DECIMAL(20,8)"}},
	...
	ProvisionBucketsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		{Name: "min_amount", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "DECIMAL(20,8)"}},
		{Name: "max_amount", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "DECIMAL(20,8)"}},
		{Name: "created_at", Type: field.TypeTime},
