...
CREATE TABLE IF NOT EXISTS "public"."sender_order_tokens" (
    ...
    "token_sender_order_tokens" int8 NOT NULL,
    PRIMARY KEY ("id")
);
...
(32, '2025-01-21 12:46:12.789689+00', '2025-01-21 12:46:12.78969+00', 0, 0, 'floating', 900, 0.5, 'AtGaDPqT', '0x409689E3008d43a9eb439e7B275749D4a71D8E2D', 'base-sepolia', '5a349408-ebcf-4c7e-98c7-46b6596e0b27', 55834574852),
(14, '2025-01-21 12:46:12.789689+00', '2025-01-21 12:46:12.78969+00', 0, 0, 'floating', 900, 0.5, 'AtGaDPqT', '0x409689E3008d43a9eb439e7B275749D4a71D8E2D', 'base-sepolia', '5a349408-ebcf-4c7e-98c7-46b6596e0b27', 55834574851);
...
INSERT INTO "public"."sender_order_tokens" ("id", "created_at", "updated_at", "fee_percent", "fee_address", "refund_address", "sender_profile_order_tokens", "token_sender_order_tokens") VALUES
...
ALTER TABLE "public"."sender_order_tokens" ADD FOREIGN KEY ("token_sender_order_tokens") REFERENCES "public"."tokens"("id");
...
-- Indices
CREATE UNIQUE INDEX senderordertoken_sender_profil_c0e12093989225f7a56a29b8ff69c3bf ON public.sender_order_tokens USING btree (sender_profile_order_tokens, token_sender_order_tokens);
